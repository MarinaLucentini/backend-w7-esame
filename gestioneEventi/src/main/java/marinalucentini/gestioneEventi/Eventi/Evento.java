...
import marinalucentini.gestioneEventi.Utente.OrganizzatoreEventi;
...
public class Evento {
    ...
    public Evento(String titolo, String descrizione, LocalDate data, String luogo, int posti_disponibili, OrganizzatoreEventi organizzatoreEventi) {
        this.titolo = titolo;
